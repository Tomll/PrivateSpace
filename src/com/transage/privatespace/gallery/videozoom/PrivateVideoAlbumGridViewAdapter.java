...
public class PrivateVideoAlbumGridViewAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        //加载视频缩略图
        Glide.with(mContext).load(listPrivFlies.get(position).getPath()).placeholder(R.color.greytext).into(viewHolder.imageView);
        ...
        viewHolder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //跳到VideoActivity播放视频
                mContext.startActivity(new Intent(mContext, VideoActivity.class).putExtra("videoPath", listPrivFlies.get(position).getPath()));
            }
        });
        return convertView;
    }
